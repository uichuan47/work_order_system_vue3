<template>
  <div class="box">
    ...
    >
      ...
      <el-form-item label="cPassword" prop="pass">
...
function doLogin() {
  _axios.post("/api/register/", form.value).then((res) => {
  ...
  // let info = {id: 1, name: username.value, token: "xxasdasd"}
  // store.doLogin(info)
  // router.push({path: "/course/course1"})
}
